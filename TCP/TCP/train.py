...
if __name__ == "__main__":
	...
	parser.add_argument('--root_dir_train', type=str, default='')
	...
	# Data
	train_set = CARLA_Data(root=args.root_dir_train, data_folders=args.root_dir_train, img_aug = config.img_aug)
	print(len(train_set))
