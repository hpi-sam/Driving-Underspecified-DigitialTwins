...
def init_parser():
    ...
    parser.add_option('--data_path', type=str, default='')
    parser.add_option('--val_data_path', type=str, default='')
    parser.add_option('--output_path', type=str, default='')
    parser.add_option('--fixed_theme', type=str, default=None)
    ...
    parser.add_option('--num_trajectories', action='store', type=int, default=50)
