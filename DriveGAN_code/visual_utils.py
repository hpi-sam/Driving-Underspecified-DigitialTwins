...
def draw_output(gout, actions, false_actions, states, opts, vutils, logger, it, latent_decoder=None,
    ...
    print('states_', states_[0][0][0][0])
    gt = visualize_tensor(states_, tag + '_output/GTImage', logger, vutils, it)
    ...
    generated = visualize_tensor(x_gen, tag + '_output/GenImage', logger, vutils, it)
